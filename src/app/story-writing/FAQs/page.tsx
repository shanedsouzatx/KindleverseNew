...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <ul className=" pl-5 space-y-1 text-[#3498DB]">
        <li>➤ Experience in your selected genre</li>
        <li>➤ Ability to come up with relatable and interesting plots and characters</li>
        <li>➤ Comprehension of your overall vision</li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <ul className=" pl-5 space-y-1 text-[#3498DB]">
        <li>
          ➤ <strong>Expertise:</strong> Professionals offer knowledge and experience in crafting gripping stories.
        </li>
        <li>
          ➤ <strong>Objective Perspective:</strong> Gives a new and unbiased analysis of your story’s strengths and weaknesses.
        </li>
        <li>
          ➤ <strong>Quality:</strong> They ensure your narrative is flawless, error-free, and well-organized.
        </li>
        <li>
          ➤ <strong>Time-Saving:</strong> Outsourcing lets you focus on other aspects of life or work.
        </li>
        <li>
          ➤ <strong>Feedback:</strong> Get constructive suggestions and critiques for improvements.
        </li>
        <li>
          ➤ <strong>Market Readiness:</strong> Professionals help tailor your story for your target market or audience.
        </li>
      </ul>
    ),
  },
